...
public class InsertComputerActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Button btnInsertBook =(Button) findViewById(R.id.buttonInsertComputer);
		btnInsertBook.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(authorData==null)
				{
					Toast.makeText(InsertComputerActivity.this, "Please choose an catergory to insert", Toast.LENGTH_LONG).show();
					return;
				}
				...
				if(bId>0)
				{
					Toast.makeText(InsertComputerActivity.this, "Insert Comuter OK", Toast.LENGTH_LONG).show();
					loadListBookByAuthor(authorData.getField1().toString());
				}
				else
				{
